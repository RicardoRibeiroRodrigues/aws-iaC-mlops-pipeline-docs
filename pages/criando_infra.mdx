...
<Callout type="warning">
  É recomendado que o usuário que você esteja usando as chaves de acesso tenha permissão `AdministratorAccess`, já que fica mais simples, porém é seria possível rodar tendo acesso à todos os serviços que são mostrados [na arquitetura](/infraestrutura)
</Callout>
