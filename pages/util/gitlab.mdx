...
<Callout type="info" emoji="ℹ️">
  Se você proteger a branch que vai ser utilizada e fizer mirror apenas em [branchs protegidas](https://docs.gitlab.com/ee/user/project/protected_branches.html), o push será mais rápido, fazendo com que a pipeline ative mais rápido também.
</Callout>
